...
if (isset($submit)){
	...
	$ICL_PORT = ($from_port?$from_port:143);
	$from_conn = iil_Connect($from_host, $from_login, $from_password);
	$ICL_PORT = ($to_port?$to_port:143);
...
<table><tr>
	<td>
	<b>From:</b>
	<br>Host:<input type="text" name="from_host" value="<?php echo $from_host?>">:<input type="text" name="from_port" value="<?php echo $from_port ?>" size=3>
	<br>Login:<input type="text" name="from_login" value="<?php echo $from_login?>">
	<br>Password:<input type="password" name="from_password" value="<?php echo $from_password?>">
	...
	<td>
	<b>To:</b>
	<br>Host:<input type="text" name="to_host" value="<?php echo $to_host?>">:<input type="text" name="to_port" value="<?php echo $to_port ?>" size=3>
	<br>Login:<input type="text" name="to_login" value="<?php echo $to_login?>">
	<br>Password:<input type="password" name="to_password" value="<?php echo $to_password?>">
