...
include("../include/icl.inc");
	...
	$fieldOptions = "<select name=\"srchp[field]\">\n";
	...
	$dateOptions = "<select name=\"srchp[date_operand]\">\n";
	...
	$str = str_replace("%value", '<input type="text"  name="srchp[string]" >', $str);
	$str = str_replace("%m", '<input type="text" name="srchp[month]" value="mm" size=2>', $str);
	$str = str_replace("%d", '<input type="text" name="srchp[day]" value="dd" size=2>', $str);
	$str = str_replace("%y", '<input type="text" name="srchp[year]" value="yyyy" size=4>', $str);
?>
<form method="POST" action="main.php">
	<input type="hidden" name="user" value="<?php echo $sid; ?>">
	<input type="hidden" name="cmc" value="1">
